...
$session=$_SESSION['id'];
include 'db.php';
$result = mysqli_query($conn,"SELECT * FROM user WHERE id= '$session'") or die('Error');
...
if (isset($_POST['add']))
	...
	include 'db.php';
		 ...
		 mysqli_query($conn,"INSERT INTO  owners (id,lname,fname,mi,subcity,houseno) 
		 VALUES ('$id','$lname','$fname','$mi','$subcity','$houseno')"); 
